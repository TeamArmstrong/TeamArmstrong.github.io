...
I am a third year student in UTSC where I major in Computer Science. C# is my first programming language and over the years I have learned Python, Java, php, C, HTML and SQL. I have built several small projects on my own with jQuery and Javascript. I am familiar with JSON Server construction and fully experienced in Android application development. Programming within diverse environments makes me an experienced programmer. Also, I am very interested in the development of Bitcoin, self-driving cars and VR. Placeholder: Video provides a powerful way to help you prove your point. When you click Online Video, you can paste in the embed code for the video you want to add. You can also type a keyword to search online for the video that best fits your document. Video provides a powerful way to help you prove your point. When you click Online Video, you can paste in the embed code for the video you want to add. 
